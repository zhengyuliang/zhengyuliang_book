...
* [技术类](technology/README.md)
	...
	* [理解Vue.mixin，利用Vue.mixin正确的偷懒](technology/理解Vue.mixin，利用Vue.mixin正确的偷懒.md)
	* [7道javascript题，让你理解基本的javascript](technology/7道javascript题，让你理解基本的javascript.md)
	* [异步神器Async-await介绍与填坑](technology/异步神器Async-await介绍与填坑.md)
	* [JavaScript数组求并集，交集和差集](technology/JavaScript数组求并集，交集和差集.md)
